...
for i,N in enumerate(Ns):
    ...
    np.save(f"results/accepted{N}.npy",accepted)
    ...
    plt.legend()
    plt.savefig(f"results/thermalisation/ω_squared_{N}.png")
    plt.close()
    ...
    plt.legend()
    plt.savefig(f"results/thermalisation/S_squared_{N}.png")
    plt.close()
    ...
    plt.legend()
    plt.savefig(f"results/Binning_analysis{N}.png")
    plt.close()


np.save("results/ω_squareds.npy",ω_squareds)
np.save("results/S_squareds.npy",S_squareds)
np.save("results/times.npy",times)
np.save("results/error_ω_squareds.npy",error_ω_squareds)
np.save("results/error_S_squareds.npy",error_S_squareds)
np.save("results/autocorr_time_ω_squared.npy",autocorr_time_ω_squareds)
np.save("results/autocorr_time_S_squared.npy",autocorr_time_S_squareds)
